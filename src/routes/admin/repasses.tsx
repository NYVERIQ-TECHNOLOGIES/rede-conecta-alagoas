...
function Repasses() {
  ...
  const field =
    "rounded-md border border-line bg-panel-2 px-3 py-2 text-[13px] outline-none focus:border-leaf";
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <StatCard
          label="Aguardando"
          value={brl(aguardando.reduce((a, s) => a + Number(s.net_amount), 0))}
          tone="clay"
        />
