...
export const Route = createFileRoute("/admin/cooperativas/")({
  head: () => ({
    meta: [
    ...
    <>
      ...
      {isAdmin && form && (
        <Panel
          ...
          subtitle="Território, contato e taxa de comissão da rede"
        >
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <Link to="/admin/cooperativas/$id" params={{ id: c.id }} className="min-w-0">
                ...
                <Link to="/admin/cooperativas/$id" params={{ id: c.id }} className="block">
